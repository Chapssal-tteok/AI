...
위의 정보를 바탕으로, 지원자의 자기소개서 경험과 기업·직무 특성을 반영한 면접 질문 1개를 생성해주세요.
...
# Output Format
1. 읽기 쉽고 명확한 문장 구조를 사용합니다.
2. 오직 질문만 출력하세요. 어떤 설명도 붙이지 마세요.
3. 질문은 1~2 문장으로 구성하고, 줄바꿈 없이 출력하세요.
4. 출력에는 따옴표("), 작은따옴표('), 백틱(`) 등을 포함하지 마세요.
